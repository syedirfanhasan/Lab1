...
struct outTestCase1{    // used to test routines
  ...
  unsigned char OutBuffer[12];   // Output String
};
...
int main(void){
  uint32_t i;
  unsigned char titleText1[19] = {'L','a', 'b', '1',' ','S','T','7','7','3','5','_','s','D','e','c','O','u','t','3'};
  unsigned char titlePlot1[10] = "Circle";
  unsigned char titlePlot2[10] = "Star";
  //PLL_Init(Bus80MHz);
  PLL_Init();
  PortF_Init();
  ...
  while(1){
    ...
    ST7735_OutString(1,1,(unsigned char *)titleText1,ST7735_WHITE,19);
    //ST7735_SetCursor(0,0);
    //printf("Lab 1\rST7735_sDecOut3\r");
    for(i=0; i<12; i++){
      ST7735_sDecOut3(outTests1[i].InNumber,i+2,5);  // your solution
      DelayWait10ms(100);
      //ST7735_OutString(5,i,(unsigned char*)outTests1[i].OutBuffer,ST7735_WHITE); // expected solution
    }
    //Pause();
    ...
    for(i=0; i<14; i++){
      ST7735_uBinOut8(outTests2[i].InNumber,i+2,5);  // your solution
      DelayWait10ms(100);
      //ST7735_OutString(5,i,(unsigned char*)outTests2[i].OutBuffer,ST7735_WHITE); // expected solution
    }
    //Pause();
    ...
    ST7735_FillScreen(ST7735_BLACK);
    ST7735_OutString(1,1,(unsigned char *)titlePlot1,ST7735_WHITE,19);
	ST7735_PlotClear(-2500, 2500, -2500, 2500);
	ST7735_XYplot(180,(int32_t *)CircleXbuf,(int32_t *)CircleYbuf);
*/
    ST7735_FillScreen(ST7735_BLACK);
    ST7735_OutString(1,1,(unsigned char *)titlePlot2,ST7735_WHITE,19);
	ST7735_PlotClear(-450, 150, -400, 200);
	ST7735_XYplot(180,(int32_t *)StarXbuf,(int32_t *)StarYbuf);
}
